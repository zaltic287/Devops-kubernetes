...
ZOO_ID=$(hostname | sed "s/zook//g")

if [[ ${ZOO_ID} == "1" ]];then ZOO1="server.4=0.0.0.0:2888:3888"; else ZOO1="server.4=zook1:2888:3888";fi
if [[ ${ZOO_ID} == "2" ]];then ZOO2="server.5=0.0.0.0:2888:3888"; else ZOO2="server.5=zook2:2888:3888";fi
if [[ ${ZOO_ID} == "3" ]];then ZOO3="server.6=0.0.0.0:2888:3888"; else ZOO3="server.6=zook3:2888:3888";fi
