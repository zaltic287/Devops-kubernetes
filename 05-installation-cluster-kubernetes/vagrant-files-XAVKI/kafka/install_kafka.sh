...
#if [[ ${BROKER_ID} == "4" ]];then BROKER4="server.4=0.0.0.0:2888:3888";KRAFT4="4@localhost:9093"; else BROKER4="server.4=kafka4:2888:3888";KRAFT4="4@kafka4:9093" ;fi
...
node.id='${BROKER_ID}'
controller.quorum.voters='${KRAFT1}','${KRAFT2}','${KRAFT3}', '${KRAFT4}'
