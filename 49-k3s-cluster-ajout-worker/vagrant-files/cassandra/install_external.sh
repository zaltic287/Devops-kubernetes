...
pip3 install cqlsh
cqlsh cassandra1 -e "CREATE KEYSPACE IF NOT EXISTS Saliou WITH replication = {'class': 'SimpleStrategy', 'replication_factor': 2} ;"
cqlsh cassandra1 -e "CREATE TABLE IF NOT EXISTS Saliou.T1 ( uid varchar PRIMARY KEY, text varchar );"
}
