...
wget https://raw.githubusercontent.com/criteo/cassandra_exporter/master/grafana/cassandra_default.json -P /var/lib/grafana/
...
- name: 'cassandra-exporter'
  ...
  updateIntervalSeconds: 10 
  options:
    path: /var/lib/grafana/cassandra_default.json
" > /etc/grafana/provisioning/dashboards/dashboard-cassandra-exporter.yml

sed -i s/'${DS_PROMETHEUS}'/'prometheus'/g /var/lib/grafana/cassandra_default.json
